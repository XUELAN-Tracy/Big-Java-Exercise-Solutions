...
/**
 * Letter E thatcan be positioned anywhere.
 * @author xuelan
 */
public class HelloLetterE {
	...
	/**
	 * Construct a letter E with a given position.
	 * @param x the x coordinate of the top left corner
	 * @param y the y coordinate of the top left corner
	 * @param sizeLetter the width of the letter
	 */
	public HelloLetterE(int x, int y, int sizeLetter) {
		xLeft = x;
		yTop = y;
		size = sizeLetter;
	}
	...
	public void draw(Graphics2D g2) {
		...
		// Setes the points of the letter
